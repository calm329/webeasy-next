export const prompt = {
      ...
      list: [
        {
          name: "button1",
          label:
            "*insert call to action here, it should only be a couple of words long*",
          type: "External",
        },
      ],
    },
  ...
  hero: {
    ...
    image: {
      heroImagePrompt:
        "*Create a prompt for dall-e-3 to create a hero image to represent the business and content from the instagram posts in a simple above the fold style*",
      imageId:
        "*The id of the post that best matches the heading and subheading*",
      alt: "",
      show: true,
    },
