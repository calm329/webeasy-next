  ...
  return (
    <>
      ...
      <div>
        ...
        <p>
          My Website follows a standard procedure of using log files. These
        ...
        <p>
          Note that My Website has no access to or control over these cookies
        ...
        <p>
          My Website&apos;s Privacy Policy does not apply to other advertisers
