...
export default function Privacy() {
  return (
    <div>
      <p>
        <strong>Privacy Policy for WebEasy.AI</strong>
      </p>
      <p>
        <br />
      </p>
      <p>
        ...
        collected and recorded by My Website and how we use it.
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        shared and/or collect in&My Website. This policy is not applicable to
      ...
      <p>
        My Website follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, My Website uses &quot;cookies&quot;. These
      ...
      <p>
        ...
        advertising partners of&My Website.
      </p>
      <p>
        <br />
      </p>
      <p>
        ...
        advertisements and links that appear on&My Website, which are sent
      ...
      <p>
        Note that My Website has no access to or control over these cookies that
      ...
      <p>
        My Website&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        My Website does not knowingly collect any Personal Identifiable
