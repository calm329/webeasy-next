...
const PricingContent = (props: TProps) => {
      ...
      updateAppState({
        ...
        aiContent: {
          ...
          pricing: {
            ...
            button: {
              ...appState.aiContent?.pricing?.list,
              list: appState.aiContent?.pricing?.list?.filter(
                (pricing: any) => {
                  if (pricing.id !== id) {
                    return pricing;
                  }
  ...
  return (
    <div className="h-[55vh] max-h-[600px]  overflow-y-auto py-5 transition-all ease-in-out">
      <form action="" className="flex flex-col gap-5 px-4 sm:px-6">
        {appState.aiContent?.pricing &&
          Object.keys(appState.aiContent?.pricing).map((data) => (
            <>
              {(() => {
                switch (data) {
                  case "title":
                    return (
                      <div className="flex flex-col border-t pt-5">
                        ...
                        <input
                          ...
                          ref={inputRef}
                          value={appState.aiContent?.pricing?.title}
                        />
                      </div>
                    );
                  case "description":
                    return (
                      <div className="flex flex-col border-t pt-5">
                        ...
                        <textarea
                          ...
                          ref={textareaRef}
                          value={appState.aiContent?.pricing?.description}
                        />
                      </div>
                    );
                  case "list":
                      ...
                      <div className="flex flex-col gap-5 border-t pt-5">
                        <div className="flex justify-between gap-10">
                          ...
                          {/* <Switch
                            ...
                            checked={appState.aiContent?.pricing?.list?.show}
                          /> */}
                        </div>
                        ...
                        {/* {appState.aiContent?.pricing?.list?.length !== 2 && (
                          <button
