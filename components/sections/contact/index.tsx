import {
  ...
  const [loading, setLoading] = useState(true);
    ...
    const styles: {
      ...
      2: {
        container: "mx-auto flex justify-between max-w-7xl flex-row-reverse max-lg:flex-col",
        listContainer: "",
        contentContainer: "",
        listCard: "",
      },
      3: {
        container: "mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 text-center",
        listContainer: "",
        contentContainer: "",
        listCard: "",
      },
      4: {
        container: "mx-auto flex justify-between max-w-7xl flex-row-reverse max-lg:flex-col text-center",
        listContainer: "",
        contentContainer: " ",
        listCard: "",
      },
