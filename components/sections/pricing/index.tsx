...
export default function PricingSection(props: TProps) {
  ...
  const styles: {
    ...
    2: {
      container: 'mx-auto max-w-7xl px-6 lg:px-8',
      listContainer:
        'isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 gap-10',
      listCard:
        'flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 rounded-xl',
